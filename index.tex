...
\begin{acknowledgement}
  衷心感谢导师赵争鸣教授、陈凯楠老师对本人的精心指导。他们的言传身教将使我终生受益。

  在美国弗吉尼亚理工大学进行三个月的研究期间，承蒙李泽元教授、郦强教授、冯君杰师兄的热心指导与帮助，不胜感激。

  感谢刘昊天同学在系统需求分析、硬件设备、论文排版上的帮助。

  感谢在软件开发过程中的所有开源库和工具链（多达数千，恕不能一一列出）。
  也感谢在论文写作中用到的git、\LaTeX、latexmk、gnu-make等工具，
  以及最重要的\thuthesis\footnote{\href{https://github.com/xueruini/thuthesis}{https://github.com/xueruini/thuthesis}}，帮我节省了不少时间。
\end{acknowledgement}
