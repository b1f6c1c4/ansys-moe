...
\ifdefined\imprint
  \def\forceonevenpage{\ifodd\value{realpage}\blankpage\fi}
  \def\forceonoddpage{\ifodd\value{realpage}\relax\else\blankpage\fi}
  \newcommand{\forceoddpage}{
    \wlog{forceoddpage: from \therealpage}
    \edef\oldrealpage{\therealpage}
    \FloatBarrier
    \wlog{forceoddpage: to \therealpage}
    \ifnum\oldrealpage=\value{realpage}
      \wlog{forceoddpage: reversed}
      \forceonevenpage
    \else
      \wlog{forceoddpage: plain}
      \forceonoddpage
    \fi
  }
\else
